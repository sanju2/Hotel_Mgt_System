...
<head>
    ...
    <title>Green_Mount Hotel || Tour Reservation Management</title>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav" id="nav-topics">
                    ...
                    <li class="active"><a href="#">Tour Reservation</a></li>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h2 class="room_mngmnt">
                        <a href="{{ url('/tour_reservation_management') }}">Tour <b>Reservations</b></a>
                    </h2>
                </div>
            ...
            <tbody>
                @foreach ($reservations as $reservation)
                    <tr>
                        ...
                        @foreach ($tt as $rtype)
                            @if ($ttype->id == $reservation->t_id)
                                <td>{{ $ttype->name }}</td>
                            @endif
                        @endforeach

                        <td>{{ $reservation->tour_no }}</td>
                        ...
                        <td>
                            ...
                            <a href="/update_tour_reservation/{{ $reservation->id }}" class="edit">
                                <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                            </a>

                            <a class="delete" role="button" data-toggle="modal" data-target="#deleteReservationModal"
                               data-id="{{ $reservation->id }}" data-url="{{ url('treserves', $reservation->id) }}">
...
<div id="addReservationModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="/add_tour_reservation">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="rtype" class="form-control">
                            @foreach ($tt as $item)
                                @if (isset($item))
                                    <option value="{{ $item->id }}" @if (old('ttype') == $item->id) selected
...
<div id="searchReservationModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="/search_tour_reservation">
                {{ csrf_field() }}
