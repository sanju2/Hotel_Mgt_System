...
<head>
  ...
  <style>
    body {
      background-image: url("{{asset('images/guide_reg.jpg')}}");
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <div class="col-sm-offset-3 col-sm-9">
            <button type="submit" class="btn btn-primary" value="Register" name="register"><span class="glyphicon glyphicon-user"></span> Register</button><br />
            <a href="/glog" class="btn btn-info" role="button">Login Here(Already have an account)</a>
          </div>
        </div>
      </div>
    </div>
