...
<div class="model" id="form_body">
    <div class="model-dialog">
        <div class="model-content">
            <form method="post" action="/edit_tour_type" class="form-control-static" id="updateroomform">
                {{ csrf_field() }}

                <div class="model-header">
                    <button type="button" class="close" data-dismiss="model" aria-hidden="true"
                            onclick="window.location='/tour_type_management';">&times;
                    </button>

                    <h4 class="model-title">Update Tour Type</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="model-footer">
                        <input type="button" class="btn btn-default" data-dismiss="model" value="Cancel"
                               onclick="window.location='/tour_type_management';">
