...
<div class="model" id="form_body">
    <div class="model-dialog">
        <div class="model-content">
            <form method="post" action="/edit_tour" class="form-control-static" id="viewform">
                {{ csrf_field() }}
                ...
                <div class="model-header">
                    ...
                    <h4 class="model-title">Update Tour</h4>
                </div>

                <div class="model-body">
                    <div class="form-group">
                        <label>Tour No</label>
                        <input type="text" name="t_no" class="form-control" value="{{ $details->id }}" disabled>
                    </div>
