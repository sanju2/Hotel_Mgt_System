...
<head>
    <title>Green_Mount Hotel|| Online Tour Reservation</title>
...
<div class="page">
    <div class="container" id="contain">
        <h3 class="title-w3-agileits title-black-wthree" id="t">Tour Reservation</h3>
        ...
        <form method="post" action="/treserve_online">
            {{ csrf_field() }}
            ...
            <div class="form-border">
                <div class="row" id="res_row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="panel panel-primary" id="s">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label id="select_label">Tour Type</label>
                                ...
                                <!--
                                    ...
                                    <select name="rtype" class="form-control">
                                        @foreach ($rt as $item)
                                            @if (isset($item))
                                                <option value="{{ $item->id }}" @if (old('ttype') == '{{ $item->id }}')
                ...
                <div class="buttonHolder">
                    <input type="submit" name="submit" class="btn btn-primary" value="Reserve Tour"/>
                </div>
            </div>
        </form>
