...
<head>
    ...
    <title>Green_Mount Hotel || View Tour Reservation</title>
...
<div class="model" id="model1">
    <div class="model-dialog" id="model1-dialog">
        <div class="model-content">
            <form method="post" action="/edit_tour_reservation" class="form-control-static" id="resform">
                {{ csrf_field() }}

                <div class="model-header">
                    <button type="button" class="close" data-dismiss="model" aria-hidden="true"
                            onclick="window.location='/tour_reservation_management';">&times;
                    </button>

                    <h4 class="model-title" id="title2">Update Tour Reservation</h4>
                </div>
                ...
                <div class="model-body" id="body">
                    ...
                    <div class="col-md-6" id="col2">
                        ...
                        <div class="form-group">
                            <label>Tour No</label>
                            <input type="text" name="t_no" class="form-control" value="{{ $details->tour_no }}">
                        </div>
                ...
                <div class="model-footer" id="foot">
                    ...
                    <input type="button" class="btn btn-default" data-dismiss="model" value="Cancel"
                           onclick="window.location='/tour_reservation_management';">
