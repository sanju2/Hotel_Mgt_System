...
class TourTypeValidation extends FormRequest
{
    /**
    ...
    {
        return [
            't_id' => 'required|unique:tour_types,id|numeric',
            'desc' => 'required|max:20|string',
            't_name' => 'required|unique:tour_types,name|max:100|string',
    ...
    public function messages()
    {
        return [
            ...
            't_id.unique' => 'ERROR: Entered tour type id has already been taken!',
            ...
            't_name.unique' => 'ERROR: Entered tour type name has already been taken!'
        ];
    }
}
