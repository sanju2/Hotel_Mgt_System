...
<head>
    ...
    <title>Green_Mount Hotel || View Tour</title>
            ...
            <form method="post" class="form-control-static" id="viewform">
                ...
                <div class="model-header">
                    <button type="button" class="close" data-dismiss="model" aria-hidden="true"
                            onclick="window.location='/tour_management';">&times;
                    </button>

                    <h4 class="model-title">View Tour</h4>
                </div>
                ...
                <div class="model-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tourtype" class="form-control" disabled>
                            <option value="{{ $details->t_id }}" selected>{{ $tt_details->name }}</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="price" class="form-control" disabled>
                            <option value="{{ $details->price }}" selected>{{ $details->price }}</option>
                        </select>
                    </div>
                ...
                <div class="model-footer">
                    <input type="button" class="btn btn-default" data-dismiss="model" value="Cancel"
                           onclick="window.location='/tour_management';">
                </div>
            </form>
        </div>
    </div>
